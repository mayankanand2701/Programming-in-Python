...
for x in student:
    marks=x["Science"]
    id=x["student id"]
    if(marks<=30):d["less or equal to 30"].append(id)
    elif(marks>30 and marks<=70):d["between 30 and 70"].append(id)
    elif(marks>70):d["more than 70"].append(id)
    
print("Below are the student_id of the students that lie in the range of the given marks : ")
for id in d:print(id," : ",d[id])

...
# creating list for the student id and their respective marks
id=[]
csmarks=[]
for x in student:
    id.append(x["student id"])
    csmarks.append(x["Computer Science"])
    
# plotting the line chart from the above collected data
import matplotlib.pyplot as plt
plt.plot(id,csmarks,marker='o')
plt.xlabel("Student ID")
plt.ylabel("Computer Science Marks")
plt.title("ID vs Marks")
plt.xticks(id)  # To show all student IDs
